...
SENTIMENT_SYSTEM = (
    "You are a market-sentiment classifier. Given a distilled summary, return ONLY a JSON object: "
    ...
    'Include one observation per ticker/sector/theme discussed, plus one subject_type "market" '
    'with subject "ALL" for the overall tone.'
)
